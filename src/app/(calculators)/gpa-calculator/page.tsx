      ...
      <main className="flex-1 p-4 md:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Card>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <CardFooter>
                  <Button type="submit" className="w-full bg-accent hover:bg-accent/90">Calculate GPA</Button>
                </CardFooter>
              </form>
            </Card>
            ...
            {result && (
              <Card className="w-full bg-primary/5">
                <CardHeader>
                  <CardTitle className="font-headline">Your GPA</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4 text-center">
                    <div className="text-6xl font-bold text-primary">{result.gpa.toFixed(2)}</div>
                    <p className="text-muted-foreground">Based on {result.totalCredits} total credits.</p>
                </CardContent>
                <CardFooter>
                  <SharePanel resultText={`My GPA is ${result.gpa.toFixed(2)}!`} />
                </CardFooter>
              </Card>
            )}
          </div>
          <Card className="mt-8">
            ...
            <CardContent>
              <p className="mb-4">
                GPA, or Grade Point Average, is a standard way of measuring academic achievement. It is calculated by taking the sum of the grade points earned for each course multiplied by the course's credit hours, then dividing that sum by the total number of credit hours taken.
              </p>
                ...
                <div>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger>What is the difference between weighted and unweighted GPA?</AccordionTrigger>
                      <AccordionContent>
                       An unweighted GPA is typically on a 4.0 scale, where an 'A' is always 4.0 points, regardless of course difficulty. A weighted GPA gives more points to advanced courses (like AP or Honors), often on a 5.0 scale. This calculator uses an unweighted scale.
                      </AccordionContent>
                    </AccordionItem>
                     <AccordionItem value="item-2">
                      <AccordionTrigger>How can I improve my GPA?</AccordionTrigger>
                      <AccordionContent>
                       Improving your GPA involves earning higher grades, especially in courses with more credit hours, as they have a larger impact on the overall average.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </div>
