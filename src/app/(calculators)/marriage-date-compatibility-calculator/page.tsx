        ...
        <main className="flex-1 p-4 md:p-8">
            <div className="max-w-4xl mx-auto">
                ...
                <Card className="mt-8">
                  ...
                  <CardContent>
                      <p className="mb-4">
                        This calculator uses the principles of numerology to find a "Life Path Number" for each person based on their birth date. The compatibility score is then generated based on how well these two numbers interact.
                      </p>
                      <p className="mb-4 font-semibold text-destructive">
                        This calculator is for entertainment purposes only.
                      </p>
                      <p>
                        Real relationships are built on love, respect, communication, and shared values—not on numbers. Please enjoy this as a fun activity and not as a serious measure of a relationship's potential.
                      </p>
                  </CardContent>
                </Card>
            </div>
