            ...
            <div className="max-w-4xl mx-auto">
                ...
                <Card className="mt-8">
                  ...
                  <CardContent>
                      ...
                      <p>
                        The compatibility score is generated by a simple algorithm based on the names entered and is not based on any scientific study or evidence. Real relationships are complex and depend on much more than names. Have fun, but don't take the results too seriously!
                      </p>
                  </CardContent>
                </Card>
            </div>
