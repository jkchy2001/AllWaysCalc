      ...
      <main className="flex-1 p-4 md:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Analyze the profitability of an investment.</CardDescription>
              </CardHeader>
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <CardFooter>
                  <Button type="submit" className="w-full bg-accent hover:bg-accent/90">Calculate NPV</Button>
                </CardFooter>
              </form>
            </Card>
          ...
          <Card className="mt-8">
            ...
            <CardContent>
              <p className="mb-4">
                Net Present Value (NPV) is a method used in capital budgeting and investment planning to analyze the profitability of a projected investment or project. NPV is the difference between the present value of cash inflows and the present value of cash outflows over a period of time.
              </p>
                ...
                <div>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent>
                       A positive NPV indicates that the projected earnings generated by a project or investment (in present dollar terms) exceeds the anticipated costs (also in present dollar terms). Generally, an investment with a positive NPV will be a profitable one.
                      </AccordionContent>
                    </AccordionItem>
                     <AccordionItem value="item-2">
                      <AccordionTrigger>What is the discount rate?</AccordionTrigger>
                      <AccordionContent>
                       The discount rate is a key component of the NPV formula. It's the rate of return used to discount future cash flows back to their present value. It often represents the company's cost of capital or a desired rate of return.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </div>
